   ...
   void setdata(String h)
    {
        try
        {
             ...
             String query="Select * from student where id="+h+";";
             ResultSet rs=stmt.executeQuery(query);
             if(rs.next())
             {
                 ...
                 txtName.setText(d2.toUpperCase());
                 String d3=rs.getString("gender");
                 txtGender.setText(d3.toUpperCase());
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 280, -1, -1));
        ...
        btnDel.setForeground(new java.awt.Color(0, 153, 0));
        ...
        btnClose1.setForeground(new java.awt.Color(0, 153, 0));
        ...
        getContentPane().add(pAdd, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 440, 540, 40));
        ...
        getContentPane().add(pUpdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 371, 320, 60));

        txtID.setFont(new java.awt.Font("Calibri Light", 1, 14)); // NOI18N
        getContentPane().add(txtID, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 120, 220, 30));
        ...
        getContentPane().add(txtGender, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 200, 220, 30));

        jLabel9.setFont(new java.awt.Font("Times New Roman", 0, 24)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("Date of birth");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 320, 130, -1));
        ...
        getContentPane().add(txtPhone, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 240, 220, 30));
        ...
        getContentPane().add(cbYear, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 320, -1, -1));
        ...
        getContentPane().add(cbmonth, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 320, -1, -1));
        ...
        getContentPane().add(cbDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 320, -1, -1));

        txtEmail.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        getContentPane().add(txtEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 280, 220, 30));

        txtName.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        getContentPane().add(txtName, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 160, 220, 30));

        jLabel1.setFont(new java.awt.Font("Times New Roman", 0, 24)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Student ID");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 120, 110, 24));
        ...
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 40, 280, 36));
        ...
        tblstdID.setGridColor(new java.awt.Color(255, 255, 255));
        jScrollPane1.setViewportView(tblstdID);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(910, 110, 80, 190));

        lbldate.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        lbldate.setForeground(new java.awt.Color(255, 255, 255));
        getContentPane().add(lbldate, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 320, 100, 23));
        ...
        getContentPane().add(pfin, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 480, 670, 60));

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/fitness/manage/yoga-wallpaper-hd-47022-48524-hd-wallpapers.jpg"))); // NOI18N
        jLabel7.setText("jLabel7");
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(-210, -20, 1700, 760));
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        try {
            if ((txtID.getText()).compareTo("")!=0 && (txtName.getText()).compareTo("")!=0 && (txtGender.getText()).compareTo("")!=0 && (txtPhone.getText()).compareTo("")!=0 && (txtEmail.getText()).compareTo("")!=0 && (cbDate.getSelectedItem())!="" && (cbmonth.getSelectedItem())!="" && (cbYear.getSelectedItem())!=""  ){
                ...
                if(flag==1)
                {
                    String query="insert into student values ("+Integer.parseInt(txtID.getText())+",'"+txtName.getText()+"','"+txtGender.getText()+"','"+d+"',"+Double.parseDouble(txtPhone.getText())+",'"+txtEmail.getText()+ "');";
                    stmt.executeUpdate(query);
                ...
                {
                    String query="update student set name='"+txtName.getText()+"',gender='"+txtGender.getText()+"',dob='"+d+"',Phno="+Double.parseDouble(txtPhone.getText())+",email='"+txtEmail.getText()+"' where id="+txtID.getText()+";";
                    stmt.executeUpdate(query);
...
void enabled()
{
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        student_b b1 = new student_b(a,b);
       b1.setVisible(true);
b1.show();  
}
        else{
...
// TODO add your handling code here:
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String a=txtName.getText();
        String b=txtID.getText();
        student_f f1 = new student_f(a,b);
        f1.setVisible(true);
        f1.show();  
        }
        else{
...
// TODO add your handling code here:
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        String a=txtName.getText();
        String b=txtID.getText();
        class_student c1 = new class_student(a,b);
        c1.setVisible(true);
